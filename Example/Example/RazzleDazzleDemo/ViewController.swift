...
class ViewController: AnimatedPagingScrollViewController {
    fileprivate let star = UIImageView(image: UIImage(named: "Star"))
    fileprivate let iftttPresents = UIImageView(image: UIImage(named: "IFTTTPresents"))
    fileprivate let razzle = UIImageView(image: UIImage(named: "Razzle"))
    fileprivate let dazzle = UIImageView(image: UIImage(named: "Dazzle"))
    
    fileprivate let musicStand = UIImageView(image: UIImage(named: "MusicStand"))
    fileprivate let musicNotes = UIImageView(image: UIImage(named: "MusicNotes"))
    fileprivate let plane = UIImageView(image: UIImage(named: "Plane"))
    fileprivate var planePathLayer = CAShapeLayer()
    fileprivate let planePathView = UIView()
    
    fileprivate let bigCloud = UIImageView(image: UIImage(named: "BigCloud"))
    fileprivate let littleCloud = UIImageView(image: UIImage(named: "LittleCloud"))
    fileprivate let sun = UIImageView(image: UIImage(named: "Sun"))
    fileprivate let iftttCloud = UIImageView(image: UIImage(named: "IFTTTCloud"))
    
    fileprivate let page2Text = UIImageView(image: UIImage(named: "Page2Text"))
    fileprivate let page3Text = UIImageView(image: UIImage(named: "Page3Text"))
    
    fileprivate var airplaneFlyingAnimation : PathPositionAnimation?
...
//    override func viewWillTransitionToSize(to: CGSize,  with: UIViewControllerTransitionCoordinator) {
//        super.viewWillTransition(to: to, with: with)
//        with.animate(alongsideTransition: {context in
//            self.scaleAirplanePathToSize(to)
//            }, completion: nil)
//    }
    ...
    fileprivate func configureIFTTTPresents() {
    ...
    fileprivate func configureRazzleDazzleLabels() {
    ...
    fileprivate func configureMusicStand() {
    ...
    fileprivate func configurePageText() {
    ...
    fileprivate func configureClouds() {
    ...
    fileprivate func configureAirplane() {
    ...
    fileprivate func airplanePath() -> CGPath {
    ...
    fileprivate func airplanePathLayer() -> CAShapeLayer {
    ...
    fileprivate func scaleAirplanePathToSize(_ pageSize: CGSize) {
